  ...
  if (!character) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
        ...
        <Link href="/" className="text-sm text-accent-400 hover:text-accent-300">
          Voltar para lista
        </Link>
      </div>
    );
    ...
    <div className={`mx-auto max-w-7xl px-4 py-6 ${showDiceRoller ? 'sm:mr-96' : ''} transition-all`}>
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <Link
            href="/"
            className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-600 text-slate-400 transition-colors hover:border-accent-500 hover:text-accent-400"
          >
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-lg border border-slate-600 bg-slate-800 px-3 py-1.5 text-xs font-medium text-slate-300 transition-colors hover:border-accent-500 hover:text-accent-400"
          >
            Importar JSON
          </button>
          <input
